...
- **Live demo:** [open demo](https://bridge-mind.github.io/turbo-kart-rally/)
...
Arcade 3D kart racer with steering and drifting input, seven AI rivals, laps, items, race state, finish results, and procedural assets. README gives the original prompt and attributes five Claude Opus 5.5 sub-agents.
