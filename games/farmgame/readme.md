...
![FarmGame screenshot placeholder](farmgame-placeholder.svg)
...
The initial commit describes a Stardew Valley-inspired 2D farming game with tile-map rendering, player movement and a camera system. Source includes Player, Camera2D, Game1, map generation, tile map/types and project/Content pipeline files. The commit page shows a direct Claude Opus 4.6 trailer.
