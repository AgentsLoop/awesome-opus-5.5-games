# Alfred knækker koden (Alfred Cracks the Code)

> Verified game note.

![Alfred knækker koden (Alfred Cracks the Code) screenshot placeholder](alfred-kn-kker-koden-alfred-cracks-the-code-placeholder.svg)
