...
![Aliasing screenshot placeholder](aliasing-placeholder.svg)
...
- **Live demo:** [open demo](https://aliasing.pages.dev)
...
The README describes a turn-based RPG vertical slice with main menu, overworld, random encounters, battle, persistent damage, victory, defeat and restart. Source includes maps, characters, combat, battle state, game over and UI. The cited commit page shows a direct Claude Opus 4.8 trailer.
