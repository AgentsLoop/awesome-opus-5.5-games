...
![Search For The Egg screenshot](https://raw.githubusercontent.com/khaielwork6-stack/Search-For-The-Egg/main/Search_For_The_Egg_Claude_Code_Build_Pack/classes.png)
...
- [screenshot 1](https://github.com/khaielwork6-stack/Search-For-The-Egg/blob/main/Search_For_The_Egg_Claude_Code_Build_Pack/classes.png)
- [screenshot 2](https://github.com/khaielwork6-stack/Search-For-The-Egg/blob/main/Search_For_The_Egg_Claude_Code_Build_Pack/shop.png)
...
The repository contains a Roblox first-person collection and hidden-object game. The README documents the current Phase 4 playable lobby and Chapter 1, classes, parties, objectives, tools, upgrades, rounds, victory flow, persistence and headless tests. The source tree contains client controllers, server services, round/collection/objective/victory systems, a Rojo project and Studio verification docs; the cited commit adds a running-game gap probe and contains an exact Co-Authored-By: Claude Opus 5 trailer. Count one newly found non-browser engine game with fresh qualifying gameplay evidence.
