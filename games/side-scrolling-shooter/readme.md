...
- **Score:** 8.9/10
- **Screenshot rating:** 4.2/10 ([manually reviewed image](https://github.com/mohi-devhub/claude-games/blob/main/assets/shooter.gif)). Treat this as visual review only; do not infer a playtest.
- **Model:** Claude Opus 5
...
- [screenshot 1](https://github.com/mohi-devhub/claude-games/blob/main/assets/shooter.gif) — 📸 4.2/10 · manual visual review · Use this frame for the game-level score. Shows a playable scene; assess environmental detail, composition, and action readability. The frame provides limited visual evidence.
