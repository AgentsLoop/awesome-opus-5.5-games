...
- **Live demo:** [open demo](https://maoku.github.io/Opus55CatgirlPachi/)

## Screenshots

Use the source screenshot links below. The list records these assets from the game repository or a related source.

- [screenshot 1](https://github.com/Maoku/Opus55CatgirlPachi/blob/main/Opus55CatgirlPachi.jpg)
...
Playable browser pachinko with ball physics, prize pockets, payout/odds rules, editor, autoplay and results. Game commits explicitly credit Opus 5.5. Demo returned HTTP 200; no interactive playtest.
