...
![Hollow Lullaby screenshot placeholder](hollow-lullaby-placeholder.svg)
...
- **Live demo:** [open demo](https://maweis.com/rust_bevy_lua_game/)
...
The README identifies Hollow Lullaby as a Rust/Bevy game with Lua game logic, desktop, iOS and WebAssembly targets. The repository includes multiple playable packs, Lua game scripts, real audio and a published browser build. The cited commit page shows a direct Claude Opus 4.8 trailer.
