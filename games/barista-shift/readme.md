...
> Top-list entry: **this week** (#1), **this month** (#5).
...
- **Score:** 9.5/10
- **Screenshot rating:** 8.2/10 ([manually reviewed image](https://github.com/swan4er/opus-100-projects/blob/main/103-barista-shift/preview.jpg)). Treat this as visual review only; do not infer a playtest.
...
- [screenshot 1](https://github.com/swan4er/opus-100-projects/blob/main/103-barista-shift/preview.jpg) — 📸 8.2/10 · manual visual review · Use this frame for the game-level score. Shows a playable scene; assess environmental detail, composition, and action readability. The frame has strong visible polish.
