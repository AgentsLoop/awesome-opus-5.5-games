...
![Slide Jigsaw screenshot placeholder](slide-jigsaw-placeholder.svg)
...
- **Rating basis:** Game scene, controller/model/configuration, daily puzzle/rewards flow and direct Opus attribution.
- **Verified:** 2026-09-10
