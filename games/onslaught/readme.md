...
![Onslaught screenshot placeholder](onslaught-placeholder.svg)
...
- **Estimated FP32 operations/s at 60 FPS:** 4,300,000,000 (low confidence; static estimate, not measured).
- **Rating basis:** Playable FPS with weapon/ammo HUD and deployment state; score reflects a smaller verified loop than the other portal games, not a fresh playtest.
- **Verified:** 2026-09-24
...
- **Live demo:** [open demo](https://alesha-pro.github.io/bench-portal/games/onslaught-fable-5.1/)
