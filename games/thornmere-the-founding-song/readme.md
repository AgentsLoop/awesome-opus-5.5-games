...
![THORNMERE: The Founding Song screenshot](https://raw.githubusercontent.com/dgahagan/THORNMERE/HEAD/docs/screenshots/adventurers-hall.png)
...
- **Rating basis:** Complete source, tests, content data, playable dungeon loop, and direct attribution.
- **Verified:** 2026-09-09
...
README, src, data, tests, and live HTML implement a playable first-person dungeon crawler with maze rendering, enemies, items, and audio; README attributes it to Claude Fable 5.
...
- **Discovery:** https://github.com/dgahagan/THORNMERE
